...
class DotNetExecutionTests(execution.ExecutionTests):
    ...
    empty_program_runs_without_output = wip(execution.ExecutionTests.empty_program_runs_without_output)
    ...
    test_assert_true_shows_no_output = wip(execution.ExecutionTests.test_assert_true_shows_no_output)
